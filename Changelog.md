...
- **Removed a ton of vibe coded code (Shame on me I know 🥲) and optimized a lot of code - May not be visible but it's curtainly more stable.**
- Made a centralized menu logic that doesnt use any loader specific code - Code is easier to port to other versions and the mod behaves basicly the same across loaders.
- Removed key tracking when your anywhere but the game (Menus, Inventory, etc.).
